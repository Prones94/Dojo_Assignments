...
const people = [
   ...
   * Space:   O()
   */
//   function filterByKey(items, query, key, method = "startsWith") {
//     //   query = query.toUpperCase();
//     //   if (method == "startsWith"){
//     //       return items.filter(item =>
//     //           key in item &&
//     //           item[key].toUpperCase().startsWith(query)
//     //       );
//     //   }
//     //   else if (method == "endsWith"){
//     //       return items.filter(item =>
//     //           key in item &&
//     //           item[key].toUpperCase().endsWith(query)
//     //       );
//     //   }
...
//     //       );
//     //   }
//     return items.filter(item => item[key].toLowerCase()[method](query.toLowerCase()));
//   }
