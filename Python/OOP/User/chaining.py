...
charles.make_deposit(100).make_deposit(200).make_deposit(200).make_withdrawal(100).display_user_balance()

# Make Second User Deposit, Withdraw, and Display 
megan.make_deposit(500).make_deposit(300).make_withdrawal(200).display_user_balance()
